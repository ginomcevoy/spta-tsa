...
def processRequest():
    ...
    # the main parser
    desc = '''MeanOfPastSolver: answer a forecast query using the k-NN algorithm applied to the series at the medoids of
...
def configure_parent(parent_parser):
    ...
    parent_parser.add_argument('knn', help='Value of k for k-NN', type=int)
...
def train_request(args):
    ...
    region_metadata, clustering_metadata, knn_model_params = metadata_from_args(args)
    ...
    knn_model_trainer = TrainerKNN(knn_model_params, region_metadata.x_len, region_metadata.y_len)
    solver_trainer = SolverTrainer(region_metadata=region_metadata,
                                   clustering_metadata=clustering_metadata,
                                   distance_measure=DistanceByDTW(),
                                   model_trainer=knn_model_trainer,
...
def metadata_from_args(args):
    ...
    return region_metadata, clustering_metadata, knn_model_params
